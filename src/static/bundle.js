...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewReducer = __webpack_require__(207);
	...
	// dev tools
	var store = (window.devToolsExtension && window._DEV_MODE ? window.devToolsExtension()(_redux.createStore) : _redux.createStore)((0, _redux.combineReducers)({
	  state: _reducer2.default,
	  viewState: _viewReducer2.default
	}));
	
	var api = new _API2.default(store);
	  ...
	  _createClass(Moderator, [{
	    ...
	    value: function render() {
	      switch (this.props.viewState.page) {
	        case "event":
	          return _react2.default.createElement(_event2.default, null);
	        default:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _questionList = __webpack_require__(199);
	...
	exports.default = (0, _reactRedux.connect)(function (storeState) {
	  ...
	  _createClass(Event, [{
	    key: 'render',
	    value: function render() {
	      var e = this.props.state.events[this.props.viewState.state.event_id];
	      return _react2.default.createElement(
	        'div',
	        { className: 'event' },
	        _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_questionList2.default, { questions: e.questions })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _question = __webpack_require__(200);
	  ...
	  _createClass(QuestionList, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        Object.values(this.props.questions).sort(function (question) {
	          return -question.question.score;
	        }).map(function (question, _k) {
	          return _react2.default.createElement(_question2.default, { question: question, key: _k });
	        })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commentList = __webpack_require__(201);
	
	var _commentList2 = _interopRequireDefault(_commentList);
	
	var _vote = __webpack_require__(203);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_vote2.default, { upvote: this.upvote, downvote: this.downvote, score: q.score }),
	          _react2.default.createElement(
	            'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _comment = __webpack_require__(202);
	
	var _comment2 = _interopRequireDefault(_comment);
	
	var _commentInput = __webpack_require__(204);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          comments.map(function (comment, _k) {
	            return _react2.default.createElement(_comment2.default, { comment: comment, key: _k });
	          }),
	  ...
	  _createClass(Comment, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'comment' },
	        _react2.default.createElement(_vote2.default, { upvote: 1, downvote: 1, score: c.score }),
	        _react2.default.createElement(
	          'div',
	  ...
	  _createClass(Vote, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'upvote', onClick: function onClick() {} },
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'downvote', onClick: function onClick() {} },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : test_state;
	  var action = arguments[1];
	  ...
	  events: {
	    1: {
	      "event": {
	        ...
	        "moderators": ["david.stein@appboy.com"],
...
/***/ function(module, exports) {
	...
	*/
	...
	var actions = {
	  ...
	  EVENT: ["SUBMIT", "SUBMIT_ACK", "RECIEVE_LIST"],
	  QUESTION: ["SUBMIT", "SUBMIT_ACK", "RECIEVE", "VOTE", "VOTE_ACK"],
	  COMMENT: ["SUBMIT", "SUBMIT_ACK", "RECIEVE_LIST", "VOTE", "VOTE_ACK"]
	};
...
/***/ function(module, exports) {
	...
	function JSONget(uri, callback) {
	  ...
	  xmlHttp.onreadystatechange = function () {
	    if (xmlHttp.readyState == 4 && xmlHttp.status == 200) callback(JSON.parse(xmlHttp.responseText));else throw xmlHttp;
	  };
	...
	var _class = function () {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function new_comment_vote(params) {
	      JSONpost("api/new_comment_vote", params, function (data) {
	        console.log("resp to new_comment_vote:", data);
	      });
	    }
	  }, {
	    key: "new_question_vote",
	    value: function new_question_vote(params) {
	      JSONpost("api/new_question_vote", params, function (data) {
	        console.log("resp to new_question_vote:", data);
	      });
	    }
	  }, {
	    key: "new_comment",
	    value: function new_comment(params) {
	      JSONpost("api/new_comment", params, function (data) {
	        console.log("resp to new_comment:", data);
	      });
	    }
	  }, {
	    key: "new_question",
	    value: function new_question(params) {
	      JSONpost("api/new_question", params, function (data) {
	        console.log("resp to new_question:", data);
	      });
	    }
	  }, {
	    key: "new_event",
	    value: function new_event(params) {
	      JSONpost("api/new_event", params, function (data) {
	        console.log("resp to new_event:", data);
	      });
	    }
	  }, {
	    key: "get_question",
	    value: function get_question(question_id) {
	      JSONpost("api/get_question", {}, function (data) {
	        console.log("resp to get_question: ", data);
	      });
	    }
	  }, {
	    key: "get_event",
	    value: function get_event(event_id) {
	      JSONpost("api/get_event", {}, function (data) {
